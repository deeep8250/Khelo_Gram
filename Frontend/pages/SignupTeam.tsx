                  ...
                  <div>
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                           ...
                           <input type="text" placeholder="e.g. The Champion Warriors" className="block w-full px-4 py-3 border border-slate-300 dark:border-slate-700 rounded-lg focus:ring-primary focus:border-primary placeholder-slate-400 dark:placeholder-slate-500 bg-slate-50 dark:bg-slate-800 dark:text-white transition-colors" />
                        </div>
                        <div>
