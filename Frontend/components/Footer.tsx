...
const Footer: React.FC = () => {
  ...
  <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-400 max-w-xs">
    The <span className="font-medium text-slate-800 dark:text-slate-300">#1 platform</span> for tournament organizers.
    Manage brackets, registrations, and live scores effortlessly.
  </p>
</div>
