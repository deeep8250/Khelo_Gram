...
const LandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-950 min-h-screen transition-colors duration-200">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
             <button onClick={() => navigate('/signup')} className="bg-primary text-white px-8 py-3 rounded-lg text-base font-semibold hover:bg-sky-600 transition-colors shadow-lg shadow-primary/20">
              Get Started
            </button>
             <button className="bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 px-8 py-3 rounded-lg text-base font-semibold hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors">
              View Demo
            </button>
          </div>
      ...
      {/* Stats Section */}
      <div className="bg-slate-50 dark:bg-slate-900 py-16 transition-colors duration-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all">
                 <div className="h-12 w-12 bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-primary mb-4">
                    <Trophy className="h-6 w-6" />
                 </div>
                 <h3 className="text-slate-500 dark:text-slate-400 font-medium text-sm">Tournaments Hosted</h3>
                 <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">10,000+</p>
              </div>
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all">
                 <div className="h-12 w-12 bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-primary mb-4">
                    <Users className="h-6 w-6" />
                 </div>
                 <h3 className="text-slate-500 dark:text-slate-400 font-medium text-sm">Teams Registered</h3>
                 <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">50,000+</p>
              </div>
              <div className="bg-white dark:bg-slate-800 p-8 rounded-2xl shadow-sm border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all">
                 <div className="h-12 w-12 bg-blue-50 dark:bg-blue-900/30 rounded-xl flex items-center justify-center text-primary mb-4">
                    <Calendar className="h-6 w-6" />
                 </div>
                 <h3 className="text-slate-500 dark:text-slate-400 font-medium text-sm">Scores Recorded</h3>
                 <p className="text-3xl font-bold text-slate-900 dark:text-white mt-1">1M+</p>
              </div>
           </div>
        </div>
      </div>
